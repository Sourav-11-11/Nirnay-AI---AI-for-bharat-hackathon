...
export default function ExtractionScreen({ actions, selectedActionId, onSelectAction, onApprove, onSaveEdit, onContinue, pdfPreviewUrl, note, isBusy, isVerifying, isFallback }) {
    ...
    return (
        <div className="flex h-screen w-full flex-col bg-slate-50 text-slate-900 font-sans overflow-hidden">
            ...
            {/* MAIN WORKSPACE: 55/45 Split */}
            <div className="flex-1 flex overflow-hidden">

                {/* LEFT SIDE (55%) */}
                <div className="flex-[5.5] bg-slate-50/50 overflow-y-auto px-5 py-6 relative">
                ...
                {/* RIGHT SIDE (45%) - Live PDF verification panel */}
                <div className="flex-[4.5] bg-slate-200 border-l border-slate-300 relative shadow-[-10px_0_20px_-10px_rgba(0,0,0,0.05)] flex flex-col overflow-hidden">
            ...
            <div className="fixed bottom-0 left-0 w-[55%] bg-white/90 backdrop-blur-xl border-t border-slate-200 p-4 flex items-center justify-between shadow-2xl z-30 transform transition-transform">
